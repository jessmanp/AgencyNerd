...
class Home extends Controller
{
     ...
     */
		...
		if (!isset($employee_id) || $employee_id == '' || !is_numeric($employee_id)) {
			...
			$updated_employee_id = $setup_model->saveEmployeeCompensation($employee_id, $compensation_type, $compensation_rate, $compensation_other, $comp_draw, $commission_auto_new, $commission_auto_renew, $commission_fire_new, $commission_fire_renew, $commission_life, $commission_health);
